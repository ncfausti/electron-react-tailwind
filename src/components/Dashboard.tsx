        ...
        <main className="flex-1 relative z-0 bg-cordGray-darkest overflow-y-auto focus:outline-none">
          <div className="py-5">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              ...
              <div className="py-4">
                <div className="border-4 border-dashed border-gray-200 rounded-3xl h-96 bg-cordPurple px-4 py-5 border-b border-gray-200 sm:px-6">
                  <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                    <div className="ml-4 mt-2">
                      <h3 className="text-lg leading-6 font-light text-white">
                        New Interviews
                      </h3>
                      <NewInterviews />
                    </div>
